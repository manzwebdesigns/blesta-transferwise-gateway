<?php
/**
 * TransferWise payment gateway API.
 *
 * @package blesta
 * @subpackage blesta.components.gateways.nonmerchant.transfer_wise.lib
...
class TransferWiseapi
{
     ...
     * @var The payment URL
     */
    private $url = 'https://pay.transfer_wise.com/';
    /**
     * @var The refund URL
     */
    private $refund_url = 'https://www.transfer_wise.com/app/refund.pl';

    /**
     * Initializes the request parameter
     *
     * @param string $user_email The TransferWise username
    ...
    /**
     * Retrieves the payment URL to TransferWise
     *
    ...
    /**
     * Retrieves the refund URL to TransferWise
     *
     ...
     *
     * @param array $args The parameters to be send to TransferWise
